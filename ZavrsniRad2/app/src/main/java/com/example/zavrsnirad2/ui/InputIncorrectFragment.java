...
public class InputIncorrectFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_input_incorrect, container, false);
        ...
        tvQuestion = root.findViewById(R.id.tekst_pitanja6);
        tvQuestion.setText(data[1]);
        tvCorrectAnswer = root.findViewById(R.id.tekst_odgovora6);
        tvCorrectAnswer.setText(data[2]);
        tvAnswer = root.findViewById(R.id.tekst_ponudenog_odgovora6);
        tvAnswer.setText(userInput);
        tvCorrect = root.findViewById(R.id.broj_tocnih6);
        tvInterval = root.findViewById(R.id.novi_interval6);
        ...
        btnNastavi = (Button) root.findViewById(R.id.nastavi_btn6);
